...
double W_V()
{
	...
	if (a == 1)
	{
		...
		cin >> sub;
		sol = 100 * sub / content;
		cout << "The solution with content " << sol << "% w/v and dissolved substance " << sub << "g is " << sol << "ml " << endl;
		cout << "========================================================================================================================" << endl;
	}
	else if (a == 2)
	{
...
double W_W()
{
	...
	if (a == 1)
	{
		...
		cin >> sub;
		sol = 100 * sub / content;
		cout << "The solution with content " << sol << "% w/w and dissolved substance " << sub << "g is " << sol << "g " << endl;
		cout << "========================================================================================================================" << endl;
	}
	else if (a == 2)
	{
...
double V_V()
{
	...
	if (a == 1)
	{
		...
		cin >> sub;
		sol = 100 * sub / content;
		cout << "The solution with content " << sol << "% v/v and dissolved substance " << sub << "ml is " << sol << "ml " << endl;
		cout << "========================================================================================================================" << endl;
	}
	else if (a == 2)
	{
